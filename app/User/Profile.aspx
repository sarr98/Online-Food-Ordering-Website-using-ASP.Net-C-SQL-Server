<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="app.User.Profile" %>
                            ...
                            <div class="card-title mb-4">
                                <div class="d-flex justify-content-start">
                                    ...
                                    <div class="userData ml-3">
                                        ...
                                        <h6 class="d-block">
                                            <a href="javascript:void(0)">
                                                <asp:label runat="server" ID="lblCreatedDate" ToolTip="Account Created On">
                            ...
                            <div class="row">
                                <div class="col-12">
                                   <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active text-info" id="connectedServices-tab" data-toggle="tab" href="#connectedServices" role="tab"
                                                 ...
                                                 <div class="container">
                                                     <div class="row pt-1 pb-1" style="background-color:lightgray">
                                                         <div class="col-4">
                                                             ...
                                                             Payement Mode: <%# Eval("PayementMode").ToString() =="cod" ? "Cash On Delivery" : Eval("PayementMode").ToString().ToUpper()%>
                                                         </div>
                                                         <div class="col-6">
                                                          ...
                                                          <div class="col-2" style="text-align:end">
                                                              <a href="Invoice.aspx?id=<%# Eval("PaymentID") %>" class="btn btn-info btn-sm">
                                                                  <i class="fa fa-dollar mr-2"></i>Invoice</a>
                                                         </div>
                                                     </div>
