<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="app.Admin.Category" %>
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="pb-5">
                                                 ...
                                                 <div>
                                                    <asp:Image ID="imgCategory" runat="server" CssClass="img-thunbnail"/>
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lnkEdit" runat="server" CssClass="badge badge-primary"
                                                                     ...
                                                                     <asp:LinkButton ID="lnkDelete" runat="server" CssClass="badge badge-danger" Text="Delete" OnClientClick="return('Do you want to delete this category ?')"
                                                                        CommandArgument='<%#Eval("CategoryId")%>' CommandName="delete"> <i class="ti-trash"></i> </asp:LinkButton>
