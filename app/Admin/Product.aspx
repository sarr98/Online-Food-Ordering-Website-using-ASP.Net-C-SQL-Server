<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="app.Admin.Product" %>
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            ...
                                            <div>
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                                                            ErrorMessage="Quantity must be no negative"  ForeColor="Red" Display="Dynamic"
                                                ...
                                                <div class="pb-5">
                                                 ...
                                                 <div>
                                                    <asp:Image ID="imgProduct" runat="server" CssClass="img-thunbnail"/>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <asp:Repeater ID="rProduct" runat="server" OnItemCommand="rProduct_ItemCommand" OnItemDataBound="rProduct_ItemDataBound">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="lnkEdit" runat="server" CssClass="badge badge-primary" CausesValidation="false"
                                                                        CommandArgument='<%#Eval("ProductId")%>' CommandName="edit"> <i class="ti-pencil"></i> 

                                                                    </asp:LinkButton>
                                                                     <asp:LinkButton ID="lnkDelete" runat="server" CssClass="badge badge-danger" Text="Delete" CommandName="delete"
                                                                        CommandArgument='<%#Eval("ProductId")%>'  OnClientClick="return('Do you want to delete this product ?')" 
                                                                         CausesValidation="false"> <i class="ti-trash">
                                                                            </i> </asp:LinkButton>
